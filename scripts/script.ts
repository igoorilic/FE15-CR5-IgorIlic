...
class animal {
    ...
    constructor (img: string, name: string, gender: string, size: string, age: number, vaccine: boolean) {
        this.img = img;
        this.name = name;
        this.gender = gender;
        this.size = size;
...
class cat extends animal {
    ...
    furColor: string;
    URLbreed: string;
    constructor(img: string, name: string, gender: string, size: string, age: number, vaccine: boolean, breed: string, furcolor:string, URLbreed: string) {
...
(document.getElementById("sortIcon") as HTMLElement).addEventListener("click", sortingAge);
